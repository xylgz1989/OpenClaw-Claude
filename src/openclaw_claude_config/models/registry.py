...
class ModelRegistry:
    ...
    def _register_builtin_models(self):
            ...
            "qwen": {
                ...
                "models": [
                    ModelInfo(
                        ...
                        pricing_tiers=[PricingTier.PAY_PER_USE, PricingTier.ENTERPRISE],
                        context_length=1000000,
                        features=["超长上下文1M", "多模态", "代码生成", "201种语言"],
            ...
            "glm": {
                ...
                "models": [
                    ModelInfo(
                        ...
                        pricing_tiers=[PricingTier.PAY_PER_USE, PricingTier.LITE, PricingTier.PRO, PricingTier.MAX],
            ...
            "kimi": {
                ...
                "models": [
                    ModelInfo(
                        ...
                        pricing_tiers=[PricingTier.PAY_PER_USE, PricingTier.FREE, PricingTier.STANDARD, PricingTier.PRO],
        ...
        # 国际模型
        self.register_category("international", {
            "anthropic": {
                "name": "Anthropic",
                "models": [
                    ModelInfo(
